...
* Заявите, что с программой PICK шансы увеличиваются до **70-85%** (для 100% гранта).
* Объясните, почему:
...
| Параллельно | TOPIK II (5-6+) + Портфолио и Сертификаты | **Активная работа над профайлом**: участие в волонтёрстве, сбор сертификатов и наград. |
